    ...
    var ListPage = /*#__PURE__*/function () {
      ...
      _createClass(ListPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscritions.add(this.dataService.workoutsSubject.subscribe(function (workouts) {
        ...
        key: "updateWorkout",
        value: function updateWorkout(workout, value) {
          workout.done += value;
        ...
        value: function playWorkout(workout) {
          ...
          window.setTimeout(function () {
            _this2.isPlayingWorkout = workout.id;
            _this2.workoutPaused = '';
            _this2.interval = window.setInterval(function () {
              return _this2.toDo(workout);
            }, 1000);
          }, 3500);
        }
      }, {
        ...
        key: "toDo",
        value: function toDo(workout) {
          if (!workout.seconds) {
            var audio = new Audio();
            var source = document.createElement("source"); // source.setAttribute(
            //   "src",
