...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_add_add_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./pages/add/add.page */
    "./src/app/pages/add/add.page.ts");
    /* harmony import */


    var _pages_add_add_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pages/add/add.module */
  ...
  function srcAppPagesAddAddPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddPage = /*#__PURE__*/function () {
      function AddPage(modalCtrl, dataService, toastController) {
  ...
  function srcAppServicesLocalServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LocalService = /*#__PURE__*/function () {
      ...
      _createClass(LocalService, [{
        ...
        key: "updateWorkoutsOrderValue",
        value: function updateWorkoutsOrderValue() {
          var reorderWorkouts = [];
          var order = 0;
          this.workouts.forEach(function (element) {
            order++;
            element.order = order;
        ...
        key: "provisoryIdGen",
        value: function provisoryIdGen(workout) {
          return this.stringToHash(workout.summary.trim() + workout.order);
        }
      }, {
        key: "stringToHash",
        value: function stringToHash(s) {
        ...
        key: "workoutsFetch",
        value: function workoutsFetch() {
          this.workouts = this.workouts.sort(function (work1, work2) {
    ...
    LocalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], LocalService);
    /***/
  },
